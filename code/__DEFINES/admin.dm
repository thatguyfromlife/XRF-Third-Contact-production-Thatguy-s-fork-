...
#define SPAM_TRIGGER_WEIGHT_FORMULA(message) length(message) / 90000
#define SPAM_TRIGGER_WARNING 7	//Number of messages required per the time period before the spam-prevention will warn you
#define SPAM_TRIGGER_AUTOMUTE 90000	//Number of messages required per the time period before the spam-prevention will automute you
